    ...
    <Provider store={store}>
      <BrowserRouter>
        ...
        <Routes>
          ...
          {/* Judges + Admins */}
          <Route element={<ProtectedRoute allowedRoles={['superadmin', 'admin', 'judge']} />}>
            <Route path="/scoring/:eventId" element={<Scoring />} />
          </Route>

          {/* Admins only */}
          <Route element={<ProtectedRoute allowedRoles={['superadmin', 'admin']} />}>
            <Route path="/results/:eventId" element={<ResultsSummary />} />
          </Route>
          ...
          <Route path="/unauthorized" element={
            <div className="flex flex-col items-center justify-center min-h-screen gap-3">
              ...
              <p className="text-xl font-bold text-red-500">Unauthorized Access</p>
